...
class _CartScreenState extends State<CartScreen> {
  ...
  Future<void> payWithCard({required int amount}) async {
    ...
    dialog.show(msg: 'Aguarde...', max: 100, msgMaxLines: 1);
    // await dialog.show();
    ...
    return cartProvider.getCartItems.isEmpty
        ...
        : Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text('Carrinho (${cartProvider.getCartItems.length})'),
              actions: [
                IconButton(
                  onPressed: () {
                    globalMethods.showDialogg(
                        'Limpar carrinho!',
                        'Seu carrinho está sendo esvaziado!',
                    ...
                    onTap: () async {
                      ...
                      if (response.success == true) {
                        ...
                        globalMethods.authErrorHandle(
                            'Entre com a informação correta', context);
                      }
                    },
